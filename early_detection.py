...
class EarlyDetectionEngine:
    ...
    def _view_items(
        ...
        for item in data:
            ...
            # Mobula Pulse V2 splits token identity/liquidity fields into
            # item["token"] while market statistics such as
            # volume_5min/trades_5min/created_at remain at the outer
            # TokenDataSchema level. Merge both layers so no statistics
            # are lost during normalization.
    ...
    def _discovery_score(
        ...
        # Transaction breadth. Prefer Mobula's official trades_5min metric.
        total_trades = _int(
            _first(
                token,
                "trades_5min",
    ...
    def _cheap_filter_reason(
        ...
        if (
            ...
            and trades_5m < self.min_trades_5m
        ):
            return "activity"
    ...
    async def scan_once(self) -> dict[str, Any]:
        ...
        for raw in raw_items:
            ...
            if trades_5m_value <= 0:
                ...
                trades_5m_value = buys_5m_value + sells_5m_value
            debug["trades_5m_values"].append(trades_5m_value)
